...
//    @Test
//    public void testAggregationWithSampleFill5Loop() throws Exception {
//        for (int i = 0; i < 10000; i++) {
//            testAggregationWithSampleFill5();
//            tearDown();
//            setUp();
//            setUp3();
//        }
    ...
    public void testAggregationWithSampleFill5() throws Exception {
        ...
        try {
            assertQuery(haversineExp,
                    "select s, haversine_dist_deg(lat, lon, k), k from tab1 sample by 1h fill(linear)",
                    null,
                    "k",
                    true, true);
        } catch (AssertionError e) {
            System.out.println("============Failed 1");
            // Check error is stable
            try {
                assertQuery(haversineExp,
                        "select s, haversine_dist_deg(lat, lon, k), k from tab1 sample by 1h fill(linear)",
                        null,
