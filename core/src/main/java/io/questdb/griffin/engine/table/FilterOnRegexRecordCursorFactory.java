...
public class FilterOnRegexRecordCursorFactory extends AbstractDataFrameRecordCursorFactory {
    ...
    public FilterOnRegexRecordCursorFactory(
    ...
    private static final Comparator<FunctionBasedRowCursorFactory> COMPARATOR = FilterOnRegexRecordCursorFactory::compareStrFunctions;
    private static final Comparator<FunctionBasedRowCursorFactory> COMPARATOR_DESC = FilterOnRegexRecordCursorFactory::compareStrFunctionsDesc;
